...
HOSTNAME=`hostname`
MYSQL_PIDFILE=/opt/opew/stack/mysql/data/$HOSTNAME.pid

MYSQL_START="/opt/opew/stack/mysql/bin/mysqld_safe --defaults-file=/opt/opew/stack/mysql/my.cnf --socket=/opt/opew/stack/mysql/tmp/mysql.sock  --datadir=/opt/opew/stack/mysql/data --log-error=/opt/opew/stack/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
