...
HTTPD_PIDFILE=/opt/opew/stack/apache2/logs/httpd.pid


HTTPD="/opt/opew/stack/apache2/bin/httpd -f /opt/opew/stack/apache2/conf/httpd.conf"
...
. /opt/opew/stack/apache2/scripts/envvars
